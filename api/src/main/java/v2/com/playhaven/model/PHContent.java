...
/** Represents some abstract interstitial from the advertising servers.
...
public class PHContent implements Parcelable {
	 ...
	 * @param dict the server's response (JSON)
	 */
    ...
    /** Checks to see if the given JSON payload is empty or not */
    public boolean isEmpty() {
        return (context == null || context.length() == 0);
    }

    /** Gets the parsed frame dictionary */
    public HashMap<String, JSONObject> getFrames() {
        return frameDict;
    }

    /** Sets the parsed frame dictionary */
    public void setFrames(HashMap<String, JSONObject> frameDict) {
